    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="<?=SITE?>index.php?sayfa=randevularim">Randevularım</a></li>
            </ul>
            <i class="bi bi-list mobile-nav-toggle"></i>
        </nav><!-- .navbar -->

        <a href="<?=SITE?>index.php?sayfa=cikis" class="appointment-btn scrollto"> Çıkış Yap </a>
